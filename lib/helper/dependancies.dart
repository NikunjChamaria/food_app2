...
Future<void> init() async {
  ...
  Get.lazyPut(
      () => AuthReppo(apiClient: Get.find(), sharedPreferences: Get.find()));

  Get.lazyPut(() => PopularPorductController(popularProductRepo: Get.find()));
  Get.lazyPut(
      () => RecommendedPorductController(recommendedProductRepo: Get.find()));
  Get.lazyPut(() => CartController(cartRepo: Get.find()));
  Get.lazyPut(() => AuthController(authReppo: Get.find()));
